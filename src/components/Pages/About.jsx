...
const About = () => {
    return (
        <div>
            <Helmet>
                <title>Atom Gamer A.G.A - Hakkımda</title>
                <meta name="description" content="Java Script ile Minecraft Modları Yapıyorum ve Discord botları ile ilgileniyorum." />
            ...
            <div className='mt-20'>
                ...
                <div className='py-0 px-0 sm:py-8 sm:px-20'>
                    <div className='flex gap-2 py-8 px-20'>
                        ...
                        <span className='font-bold text-2xl text-gray-300 sm:mt-2'>Atom Gamer A.G.A kimdir?</span>
                    </div>
                    <div className='p-4 sm:p-1'>
                        <h2 className='text-lg text-gray-300 font-medium'>Merhaba, ben Atom Gamer Arda A.G.A!</h2>
                        <p className='text-gray-400 mt-1'>13 yaşında bir Full Stack Developer olarak, 4 yıldır yazılım dünyasına merak salmış, bu alanda kendimi geliştirmeye çalışan biriyim. Ankara'da yaşıyorum ve aynı zamanda Discord platformunda Discord botları ve yazılım ile ilgili notlar paylaşarak topluluğa katkıda bulunmaya çalışıyorum. Tüm bunlarla birlikte, ortaokul eğitimimi sürdürürken yazılımla ilgili lisans eğitimi almayı hedefliyor ve bu alanda daha ileri düzeyde çalışmalar yapmak istiyorum.</p>
                        <h2 className='text-lg text-gray-300 font-medium mt-2'>Yazılım yolculuğum</h2>
                        <p className='text-gray-400 mt-1'>Yazılım yolculuğuma ilk adımlarımı attığımda, java script geliştirme konusunda bir tutku hissettim. Şu anda favori dillerim arasında React, HTML, CSS ve JavaScript bulunuyor. Bu dilleri kullanarak etkileyici ve kullanıcı dostu web uygulamaları ve modlar geliştirmek benim için heyecan verici bir deneyim.</p>
