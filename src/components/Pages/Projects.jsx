...
const Home = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Atom Gamer A.G.A - Projeler</title>
        <meta name="description" content="Atom Gamer A.G.A'nin geliştirdiği projeleri inceleyin. Web geliştirme, Discord botları ve daha fazlası." />
      ...
      <div className='mt-20'>
        <div className='px-10'>
          ...
          <p className='text-gray-400 text-lg'>Udemy platformunda yayınlanan eğitimler</p>
        </div>
