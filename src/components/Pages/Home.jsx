...
const Home = () => {
  ...
  const projects = [
    { name: "ATOMLAND Aİ", description: "Discord sunucunuzu yeni nesil sistemlerle yönetin -yakında- (09.04.2024)", url: "https://dc.atomland.xyz", language: "react", extraLanguage: "typescript" },
    ...
    { name: "ATOMLAND DC", description: "Eylenebilceğniz bir minecraft sunucusu (22.01.2024)", url: "https://dc.atomland.xyz", language: "react", extraLanguage: "typescript" },
    { name: "ATOMLAND Bot", description: "Discord sunucunuzu zahmetsizce yönetmenizi sağlayacak bir bot (02.02.2024)", url: "https://dc.atomland.xyz", language: "react", extraLanguage: "typescript" },
  ]

  return (
    <div>
      <Helmet>
        <title>Atom Gamer Arda A.G.A - Full Stack Geliştirici</title>
      ...
      <div className='flex justify-center py-48 text-center'>
        <div>
          <h1 className='font-bold text-4xl sm:text-6xl'>Merhaba Ben <span className='text-sky-500 underline'>Atom Gamer A.G.A</span></h1>
          <p className='text-gray-400 text-lg sm:text-xl mt-2 p-1'>Full-Stack geliştiriciyim. Ankarada da yaşıyorum.<br />13 yaşındayım.</p>
        </div>
      </div>
